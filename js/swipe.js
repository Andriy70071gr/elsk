...
hammertime.on('swipe', function(ev) {
    ...
    if(v>3&&v<11)
    {
               if (typeof wv == 'object')// && typeof wv.SwipeRight == 'function')
            wv.SwipeRight();

        // m_db("swipeRight = "+ev.velocityX);

             // m_db("SwipeRight = "+typeof wv);

          }
          else if(v<-3&&v>-11){
              // m_db("swipeLeft = "+ev.velocityX);
                    if (typeof wv == 'object')// && typeof wv.SwipeLeft == 'function')
                wv.SwipeLeft();
          }
